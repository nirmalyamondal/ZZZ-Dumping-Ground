 ...
 * Plugin 'Language Test Exam' for the 'learntube_episode' extension.
 *
 *
 * @author	Nirmalya Mondal <nmondal@learntube.de>
 * @package TYPO3
 * @subpackage tx_learntubeepisode
 */
/**
 ...
 *
 * TOTAL FUNCTIONS: 2
 * (This index is automatically created/updated by the extension "learntube_episode")
 *
 */
	 ...
	 *
	 */
class tx_learntubeepisode_flexform {
	...
	function _fetch_custom_fields(){
		$columns   	= 'uid,name';
		$table  	= 'tx_learntubeepisode_domain_model_episode';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/learntube_episode/class.tx_learntubeepisode_flexform.php']){
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/learntube_episode/class.tx_learntubeepisode_flexform.php']);
}
?>
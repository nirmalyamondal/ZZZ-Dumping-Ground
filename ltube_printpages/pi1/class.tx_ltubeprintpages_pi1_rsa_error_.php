...
class tx_ltubeprintpages_pi1 extends tx_ltubeprintpages_base {
	...
	public function main($content, array $conf) {
		...
		$this->_set_flexform_values_pi1();
		if(!$this->pi1_flex_settings['storage_folder'] || !$this->pi1_flex_settings['username'] || !$this->pi1_flex_settings['password'] || !$this->pi1_flex_settings['user_pid'] || !$this->pi1_flex_settings['login_id'] || !$this->pi1_flex_settings['root_page']){
	...
	function _process_pageid_n_files(){
		...
		//print_r($this->pi1_pagestocreate);
	...
	function _login_t3_site_via_curl(){
		$username	= $this->pi1_flex_settings['username'];
		$password		= $this->pi1_flex_settings['password'];

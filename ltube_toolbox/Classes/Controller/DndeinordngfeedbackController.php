 ...
 *
 */
class DndeinordngfeedbackController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {
		$dndeinordngfeedbacks = $this->dndeinordngfeedbackRepository->findAll();
		$this->view->assign('dndeinordngfeedbacks', $dndeinordngfeedbacks);
	}

 ...
 *
 */
class HangmananswerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {
		$hangmananswers = $this->hangmananswerRepository->findAll();
		$this->view->assign('hangmananswers', $hangmananswers);
	}

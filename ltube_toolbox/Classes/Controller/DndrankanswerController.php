 ...
 *
 */
class DndrankanswerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {
		$dndrankanswers = $this->dndrankanswerRepository->findAll();
		$this->view->assign('dndrankanswers', $dndrankanswers);
	}

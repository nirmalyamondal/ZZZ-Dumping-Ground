 ...
 *
 */
class DndzuordnungfeedbackController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {
		$dndzuordnungfeedbacks = $this->dndzuordnungfeedbackRepository->findAll();
		$this->view->assign('dndzuordnungfeedbacks', $dndzuordnungfeedbacks);
	}
